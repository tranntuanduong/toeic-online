		  ...
		  <!-- /. PAGE TITLE-->
		  	...
		  	<div class="row">
				<div class="span9">
						...
						<div class="blog-post">
							...
							<p>				
								<c:set var ="kq" value="${fn:replace(grammarguidelinecontent,kitutrongdatabase,kitutronghtml)}" />
							 	<c:set var ="kq1" value="${fn:replace(kq,kitutrongdatabase1,kitutronghtml1)}" />
								<c:set var ="kq2" value="${fn:replace(kq1,kitutrongdatabase2,kitutronghtml2)}" /> 
								<c:out value="${kq}" escapeXml="true"/>
								<br/>
								<c:out value="${kq1}" escapeXml="true"/>
								<br/>
								<c:out value="${kq2}" escapeXml="true"/>
						...
						<div class="reading_description" style="overflow: auto; height: 200px; width:550px;" >
							<div id="listcomment">				
									<c:forEach items="${cmtgrammarlist}" var="list"> 
											<h4 style="background-color:yellow" class="input-large">${list.membername}</h4>
