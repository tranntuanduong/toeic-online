...
public class GrammarguidelinemanageDAO 
{
	...
	public static List<Grammarguideline> Displaysgrammarguidelinemanage (HttpServletRequest request,int start, int count,Connection conn)
	{
		...
		try 
		{
			...
			{
				request.setAttribute("msglistgrammarguidelinemanage","Chưa có bài hướng dẫn nào ");
			}
			...
			throws ServletException, IOException 
	{
		...
		if (!isMultipart)
		{
			test = "thiếu file multipart/form-data trong form";
		}
			    ...
			    if (!item.isFormField()) 
			    {
			    	...
			    	try 
			    	{
			    		...
			    		if (kt == true)
			    		{
			    			...
			    			test = "file đã tồn tại, trọn file khác";
			    		}
			    		else
			    		{		    			
